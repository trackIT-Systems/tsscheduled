...
from . import ActionReason, ButtonEntry, ScheduleConfiguration, detect_hardware
from .backends.base import PowerManager
...
class PowerManagerDaemon(threading.Thread):
    ...
    def run(self):
        ...
        try:
            ...
            if not self._device.rtc_sysclock_match(threshold=datetime.timedelta(seconds=5)):
